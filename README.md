...
Constraints:
You should write a class com.packagecasestudy.packer.Packer with a static method named pack. This method
accepts the absolute path to a test file as a String. It does return the solution as a String.
Your class should throw an com.packagecasestudy.exception.APIException if incorrect parameters are being
passed.
